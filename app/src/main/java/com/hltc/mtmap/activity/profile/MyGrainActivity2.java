 ...
 */
public class MyGrainActivity2 extends Activity {
    ...
    SwipeMenuCreator creator = new SwipeMenuCreator() {
        ...
        public void create(SwipeMenu menu) {
            ...
            deleteItem.setWidth(AMapUtils.dp2px(MyGrainActivity2.this, 100));
    ...
    private void initView() {
        btnBarLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppManager.getAppManager().finishActivity(MyGrainActivity2.this);
            }
        });
